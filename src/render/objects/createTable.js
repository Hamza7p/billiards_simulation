...
export const RAIL_HEIGHT   = CLOTH_WIDTH * 0.0478;   // ≈ 0.085 m — real drawn cushion height, used by physics too
const BODY_HALF_H   = 0.07;                   // half-thickness of the slate body
export const POCKET_RADIUS = CLOTH_WIDTH * 0.0534;   // ≈ 0.095 m — real drawn radius, single source of truth for physics too
