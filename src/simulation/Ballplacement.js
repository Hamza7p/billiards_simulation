...
/**
 * Finds the nearest legal spot to `target` that isn't occupied by another
 * ball currently in play. Balls that are pocketed or jumped-off are ignored
 * — they aren't physically on the table, so they can't block a placement.
 */
